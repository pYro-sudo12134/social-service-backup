package by.losik.imageservice.aspect;
...
public class LoggingAspect {
    ...
    @Around("@within(by.losik.imageservice.annotation.Loggable)")
    ...
    @Around("@annotation(by.losik.imageservice.annotation.Loggable)")
